...
export default function Navbar() {
  ...
  return (
    <header className={`w-full sticky top-0 z-50 transition-all duration-500 bg-white/90 backdrop-blur-md ${scrolled ? 'border-b border-[#EAEAEA] shadow-sm' : 'border-b border-transparent'}`}>
