...
export default function Navbar() {
  ...
  return (
    <header className={`w-full sticky top-0 z-50 transition-all duration-500 bg-white/80 backdrop-blur-xl ${scrolled ? 'border-b border-black/5 shadow-[0_4px_30px_rgba(0,0,0,0.03)]' : 'border-b border-transparent'}`}>
